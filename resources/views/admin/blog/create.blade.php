...
<div class="container">
    <div class="page-inner">
        <div class="page-header">
            <ul class="breadcrumbs mb-3">
                ...
                <li class="nav-item">
                    <a href="{{route('admin.blog.create')}}">Thêm mới bài viết</a>
                </li>
            </ul>
        </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <div class="card-title">Thêm bài viết của bạn</div>
                    </div>
                    <div class="card-body">
                        <form action="{{route('admin.blog.store')}}" method="post" id="exampleValidation" novalidate="novalidate" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-md-12 col-lg-12 ">
                                    <div class="form-group form-show-validation">
                                        <label for="tieude">Tiêu đề <span class="required-label">*</span></label>
                                        <input type="text" class="form-control form-control-lg" id="tieuDe" name="tieuDe" placeholder="Nhập tiêu đề cho bài viết">
                                        @error('tieuDe')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control form-control-lg" id="url" name="url" placeholder="Bạn có thể nhập hoặc không địa chỉ url của bài viết">
                                    </div>
                                    <div class="form-group">
                                        <label for="mota">Tóm tắt mô tả <span class="required-label">*</span></label>
                                        <textarea class="form-control form-control-lg" id="mota" rows="5" name="moTa" placeholder="Mô tả ngắn gọn bài viết của bạn"></textarea>
                                        @error('moTa')
                                        <div class="alert alert-danger" role="alert">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <textarea name="noiDung" id="summernote" class="form-control form-control-lg" name="noidung" rows="50"></textarea>
                                        @error('noiDung')
                                        <div class="alert alert-danger" role="alert">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="row justify-content-center">
                                        <div class=" col-lg-6">
                                            <div class="form-check form-switch">
                                                ...
                                                <input class="form-check-input" type="checkbox" name="anHien" role="switch" value="1" id="flexSwitchCheckDefault">
                                            </div>
                                        </div>
                                        <div class=" col-lg-6">
                                            <div class="form-check form-switch">
                                                ...
                                                <input class="form-check-input" type="checkbox" role="switch" name="noiBat" value="1" id="flexSwitchCheckDefault">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-12 col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="tags" class="form-control form-control-lg" id="tags" placeholder="Nhập tags cho bài viết">
                                    </div>
                                </div>
                                <div class="col-md-12 col-lg-12">
                                    <div class="form-group form-show-validation row">
                                        ...
                                        <div class="col-lg-4 col-md-9 col-sm-8">
                                            <div class="input-file input-file-image">
                                                <img class="img-upload-preview rounded" id="imagePreview" style="display:none;" alt="preview">
    ...
    <script>
        ...
        imagePreview.addEventListener('load', function() {
            ...
            imagePreview.style.alignContent = "600px";
